...
const ENGINES = [
   ...
   * 预算 38 KB:权重书 2026-09 定格 4 相位(监督拟合 Egaroucid lv.17 数据;
   * 4×9475B int8,gzip 后 wasm 约 33 KB)。档数 3~10 实测等强,取 4 是
   * "强度等价取体积":6 档要 39 KB 且无可分辨收益。 */
  { name: '黑白棋', tag: 'othello-engine-v1', kb: 38, wasm: 'othello' },
];
